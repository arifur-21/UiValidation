package com.example.validateformwithcleanarchitecture
...
import com.example.validateformwithcleanarchitecture.preseantaion.MainViewModel
import com.example.validateformwithcleanarchitecture.preseantaion.RegistrationFormEvent
import com.example.validateformwithcleanarchitecture.ui.theme.ValidateFormWithCleanArchitectureTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ValidateFormWithCleanArchitectureTheme {
            Surface(
                ...
                Column(
                    ...
                    TextField(value = state.repeatePassword, onValueChange = {
